...
def build_parser():
    ...
    parser.add_argument(
        "--strategy", choices=SUPPORTED_STRATEGIES, default="v5_dynamic",
        help="v5_dynamic (default), v3_global, v2_local, b0_batch_fifo, or b0_serial",
    )
...
def main(argv=None):
    ...
    if args.self_check:
        bounds = (q3_global_upper_bounds(Q3Config(strategy=args.strategy))
                  if args.strategy in ("v3_global", "v5_dynamic") else
